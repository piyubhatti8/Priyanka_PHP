                       ...
                       <!-- <li><a href="index.php" class="menu-top-active">DASHBOARD</a></li> -->
                            ...
                            <li>
							 ...
							 <li>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="add_state">Add State</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage_state"> Manage State</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="add_city">Add City</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage_city"> Manage City</a></li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="manage_feedback" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown">Manage Feedback<i class="fa fa-angle-down"></i></a>
