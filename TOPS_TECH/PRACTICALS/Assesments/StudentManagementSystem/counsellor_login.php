    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                ...
                <h4 class="header-line">Counsellor Login</h4>
                <div class="right-div">
            ...
            <div class="col-md-12">
			   ...
			   <div class="form-group">
					...
					<input type="text "class="form-control" name="cnm" data-bvalidator="required,email"/>
				</div>
				 <div class="form-group">
					<label>Enter Password</label>
					<input type="password" class="form-control" name="cpass" data-bvalidator="required,password" />
